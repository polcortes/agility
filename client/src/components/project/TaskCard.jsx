...
const TaskCard = ({ text, onDoubleClick, type }) => {
  ...
  return (
    <article className="group relative flex bg-light-tertiary-bg py-3 px-4 rounded-2xl items-center task">
      <span 
        className="
          draggable-section
          grid grid-cols-2 grid-rows-3 gap-1 
      ...
      <button 
        ...
        className='items-center justify-center absolute -top-1.5 right-3 translate-y-1/2 transition-all bg-tertiary-bg rounded-full hidden group-hover:flex hover:bg-light-secondary-bg'
      >

...
const TaskCard = ({ text, onDoubleClickEvent, type }) => {
  // type = "doing"
  ...
  console.log("DOUBLECLICK", onDoubleClickEvent)
  ...
  return (
    <article className="group relative flex dark:bg-dark-tertiary-bg bg-light-tertiary-bg py-3 px-4 rounded-2xl items-center task">
      ...
      <p onDoubleClick={ () => { console.log("TEXTDOUBLECLICK", text); onDoubleClickEvent(text) } } className="w-full">
        { text }
      </p>

      <button 
        onClick={ () => { console.log("TEXTDOUBLECLICK", text); onDoubleClickEvent(text) } }

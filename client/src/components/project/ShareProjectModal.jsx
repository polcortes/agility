...
const ShareProjectModal = ({ projectID, setIsShareProjectModalOpen, isShareProjectModalOpen }) => {
  ...
  return (
    <dialog className="relative min-w-96 w-1/3 z-50 px-5 flex flex-col p-3 rounded-xl" ref={ dialogRef }>
      <button className='absolute top-3 right-3 hover:text-red-500 transition-none' onClick={() => setIsShareProjectModalOpen(false)}>

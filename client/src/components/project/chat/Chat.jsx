...
const Chat = () => {
  ...
  return (
    <>
      ...
      <section ref={ sectionInputRef } onClick={ handleSectionInputClick } className="sender-section hover:cursor-text flex items-center relative w-full pl-6 h-auto min-h-[54px] max-h-24 dark:bg-dark-tertiary-bg bg-light-tertiary-bg rounded-[30px]">
      ...
      <button className="absolute bottom-7 right-7 grid place-content-center rounded-full h-inherit size-[54px] bg-the-accent-color">
